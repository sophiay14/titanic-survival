...
```{r}
#| fig-cap: "Observed and modeled relationship between age and survival."
# Observed
...
ggplot(data, aes(x = Age, y = as.numeric(Survived)-1)) +
  ...
  geom_smooth(method = "glm", method.args = list(family = "binomial"), se = TRUE, color = "#2980b9") +
